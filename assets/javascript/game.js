 ...
 $(document).ready(function() {
 	...
 	var crystalValue = "";
 	var targetNumber = Math.floor(Math.random() * 101) + 19; // Need variable to generate the computer picked number to match between 19 and 120.
 	var counter = 0; // Set a counter variable to zero.  This will increase with each crystal click.
 	var wins = 0; // Sets wins to zero. Increases and decreases with a win or lose.  It is possible to go into negative numbers.
 	// var losses = 0; // Don't need since I changed the scoring method
 ...
 //**************************************************************************************************************************
	...
	function gameSetUp() {
		...
		for (var i = 0; i < 4; i++) {
			...
			var test = crystalBank.indexOf(random);
			while (test != -1) {
				random = Math.floor(Math.random() * 12) + 1;
				test = crystalBank.indexOf(random);
			}
...
// START OF SECTION I DON'T KNOW IF I STILL NEED OR NOT
	// Not sure if I still need this section as a stand alone section since it is included in my gameSetUp().
	// Don't want to remove since I don't want to break the game.
	// Did this section first and then made the gameSetUp() afterwards. Keeping for now.
//***********************************************************************************************************************
//***********************************************************************************************************************
...
// END OF SECTION I DON'T KNOW IF I STILL NEED OR NOT
//**********************************************************************************************************************
//**********************************************************************************************************************


// BEGINS USER INTERFACE FUNCTIONS
//**********************************************************************************************************************
//**********************************************************************************************************************
	...
	$(".thumbnail").on("click", function () {
    	...
    	if (counter === targetNumber) {
      		...
      		// If the numbers match, alert a win and add the target crystal value to the player's score.
      		// $(".thumbnail").off('click');
      		alert("You win!");
      		$(".thumbnail").hide();
      		wins += targetNumber;
      	...
      	// If the user score goes over the computer number, alert a loss and subtract the target crystal value from the player's score
...
// CLOSES DOCUMENT.READY FUNCTION FROM THE TOP
});